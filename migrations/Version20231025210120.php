 ...
 */
final class Version20231025210120 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE weather (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, location_id INTEGER DEFAULT NULL, temperature VARCHAR(255) NOT NULL, humidity VARCHAR(255) NOT NULL, wind VARCHAR(255) NOT NULL, pressure VARCHAR(255) NOT NULL, uv VARCHAR(255) NOT NULL, date DATE NOT NULL, CONSTRAINT FK_4CD0D36E64D218E FOREIGN KEY (location_id) REFERENCES location (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
